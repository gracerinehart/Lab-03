...
table1 <- joined_data %>%
  ...
  flextable() %>%
  add_header_lines("Top 5 Counties with Most Cumulative Cases Per Capita")
table1
...
table2 <- joined_data %>%
  ...
  flextable() %>%
  add_header_lines("Top 5 Counties with Most New Cases Per Capita")
table2
```
...
table3 <- flextable(top_5_counties) %>%
  add_header_lines("Top 5 Counties by New Cases Per 100,000")
table3
